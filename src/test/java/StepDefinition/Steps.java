...
public class Steps {
   ...
   // System.setProperty("webdriver.gecko.driver","D:\\01-Programacion\\Drivers\\geckodriver.exe");	
		System.setProperty("webdriver.gecko.driver", "D:\\falcom\\Desktop\\IPLACEX\\Integracion Continua\\geckodriver.exe");
		System.out.println("En este paso abre el navegador google chrome"); 
		driver = new FirefoxDriver(); 
		driver.manage().window().maximize(); 
		driver.get("http://localhost:8084/home");		
	} 
	...
	public void conexionBD(String url) {
        ...
        DriverManager.getConnection(url,"root","617615");		
